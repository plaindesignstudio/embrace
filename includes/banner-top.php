<div class="full-height-div bg-light overflow-hidden">
    ...
    <div class="table-container">
        ...
        <div class="container-fluid z-index-100 h-100">
            <div class="row h-100">
                <div
                    class="col-xl-6 col-lg-6 col-md-12 col-12 z-index-100 align-self-center px-5 reveal-children-right">
                    <div class="wp-spacer-xl" id="iconswrapper"> </div>
                    <h1 class="display-4 text-primary font-weight-bold"><?php the_title(); ?></h1>
                    <?php the_excerpt(); ?>

                    <div class="wp-spacer-lg"> </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-12 col-12 z-index-100 bg-primary h-100 position-relative">
